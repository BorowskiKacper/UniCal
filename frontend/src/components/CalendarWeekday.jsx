...
const CalendarWeekday = ({ weekday, events, onEventClick, onWeekdayClick }) => {
  ...
  return (
    <div className="relative w-full h-full border-r border-zinc-700/20 last:border-r-0 flex flex-col">
      <div className="sticky top-0 z-10 bg-gray-50 dark:bg-zinc-800/90 backdrop-blur-sm border-b border-gray-200 dark:border-zinc-700">
